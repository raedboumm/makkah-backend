...
INSERT OR IGNORE INTO videos (title_ar, slug, description_ar, video_url, thumbnail_url, category_id, is_live, duration, view_count) VALUES 
  ...
  (
    ...
    'https://www.britishmuseum.org/sites/default/files/styles/uncropped_huge/public/2022-07/ka-ba-mecca-postcard.jpg?itok=SC3dFf93',
    6,
    0,
    3000,
    750
  ...
  (
    ...
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR3SCfD-7n-gkZwy4ERvDjuCDHts8S-bc7nZA&s',
    6,
    0,
    5400,
    1200
  ...
  (
    ...
    'https://img.freepik.com/premium-photo/kabaa-makaah-haij-arafat-tawaf-aid-el-adha_926199-2492756.jpg',
    5,
    0,
    3800,
    980
  ...
  (
    ...
    'https://i.ytimg.com/vi/MCkqsaa_LD4/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLDcBdiFot7RaBgz76r19NqiuakTNw',
    1,
    0,
    300,
    2500
